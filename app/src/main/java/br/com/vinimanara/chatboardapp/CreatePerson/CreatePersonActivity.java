package br.com.vinimanara.chatboardapp.CreatePerson;
...
import br.com.vinimanara.chatboardapp.utils.PersonAdapter;
import br.com.vinimanara.chatboardapp.utils.PersonDBHelper;
...
public class CreatePersonActivity extends AppCompatActivity {
    ...
    private void goToAddUserActivity(){
        Intent intent = new Intent(CreatePersonActivity.this, AddRecordActivity.class);
